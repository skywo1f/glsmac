return {
	...
	apply: (e) => {
		...
		let event_name = 'diplomatic_trade_proposed';
		if (ultimatum) {
			event_name = 'diplomatic_ultimatum_proposed';
		}
		if (military_request) {
	...
	rollback: (e) => {
		...
		let event_name = 'diplomatic_trade_updated';
		if (ultimatum) {
			event_name = 'diplomatic_ultimatum_updated';
		}
		if (military_request) {
