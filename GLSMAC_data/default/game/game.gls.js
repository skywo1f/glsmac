return (glsmac) => {
	...
	const modules = [
		'social_engineering', 'exploration', 'diplomacy', 'projects', 'unit_designs', 'unit_upgrades', 'orbitals', 'territory', 'random_events', 'bases', 'ecology', 'council', 'probes', 'conquest', 'transcendence', 'economic_victory',
