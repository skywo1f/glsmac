return (glsmac) => {
	...
	const modules = [
		'social_engineering', 'diplomacy', 'projects', 'unit_designs', 'unit_upgrades', 'orbitals', 'territory', 'bases', 'ecology', 'council', 'probes', 'conquest', 'transcendence', 'economic_victory',
