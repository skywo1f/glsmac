...
WRAPIMPL_BEGIN( StaticDef )
	...
	WRAPIMPL_PROPS
			WRAPIMPL_GET_BOOL( "is_immovable", m_movement_type == MT_IMMOVABLE )
			WRAPIMPL_GET_BOOL( "is_land", m_movement_type == MT_LAND )
			WRAPIMPL_GET_BOOL( "is_water", m_movement_type == MT_WATER )
			WRAPIMPL_GET_BOOL( "is_air", m_movement_type == MT_AIR )
			...
			WRAPIMPL_GET_BOOL( "is_missile", m_is_missile )
			WRAPIMPL_GET_CUSTOM( "cargo_capacity", Int, m_cargo_capacity )
			WRAPIMPL_GET_BOOL( "is_artillery", IsArtillery() )
			WRAPIMPL_GET_BOOL( "is_psi_attack", IsPsiAttack() )
			WRAPIMPL_GET_BOOL( "is_psi_defense", IsPsiDefense() )
		};
